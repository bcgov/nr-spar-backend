insert into spar.active_orchard_spu
  ...
  values ('101', 7, 'False', 'True', 'False'),
         ...
         ('110', 7, 'True', 'True', 'False'),
         ('144', 55, 'True', 'False', 'False'),
         ('144', 108, 'True', 'False', 'False'),
         ('163', 21, 'True', 'True', 'False'),
         ('163', 22, 'True', 'True', 'False'),
         ('206', 67, 'True', 'False', 'False'),
         ('206', 68, 'True', 'False', 'False'),
         ('214', 67, 'True', 'False', 'False'),
         ('214', 68, 'True', 'False', 'False'),
         ('217', 56, 'True', 'True', 'False'),
         ('217', 57, 'True', 'True', 'False'),
         ('230', 29, 'True', 'False', 'False'),
         ('230', 43, 'True', 'False', 'False'),
         ('235', 29, 'True', 'False', 'False'),
         ('235', 35, 'True', 'False', 'False'),
         ('235', 45, 'True', 'False', 'False'),
         ('303', 73, 'True', 'True', 'False'),
         ('303', 74, 'True', 'True', 'False'),
         ('340', 38, 'True', 'False', 'False'),
         ('340', 39, 'True', 'False', 'False'),
         ('614', 67, 'True', 'False', 'True'),
         ('614', 68, 'True', 'False', 'True'),
         ('809', 103, 'True', 'True', 'False'),
         ('809', 104, 'True', 'True', 'False');
